...
/**
 * VTimestampBehavior will automatically fill date and time related attributes.
 *
 * VTimestampBehavior will automatically fill date and time related attributes when the active record
 ...
 * 			'class' => 'zii.behaviors.VTimestampBehavior',
 ...
 * respectively, so it is not required that you configure them. If you do not wish VTimestampBehavior
 ...
 *
 * Although VTimestampBehavior attempts to figure out on it's own what value to inject into the timestamp attribute,
...
class VTimestampBehavior extends CActiveRecordBehavior {
	/**
