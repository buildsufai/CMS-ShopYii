...
<fieldset>
	...
	<?php echo $form->textAreaRow($model, 'content_short', array('class'=>'imperaviRedactor')); ?>
	<?php echo $form->textAreaRow($model, 'content_full', array('class'=>'imperaviRedactor')); ?>
...
<div class="form-actions">
    ...
    <?php if(!$model->isNewRecord) $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'link','url'=>array('/news/backend/delete', 'id'=>$model->id), 'type'=>'danger', 'label'=>'Удалить', 'htmlOptions'=> array('onClick'=>"if(!confirm('Вы уверены, что хотите удалить данный элемент?')) return false;"))); ?>
